...
Devmfm:set(DevProx.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
Devmfm:sadd(DevProx.."List:Cmd:Group:New"..msg.chat_id_,"ا")
Devmfm:set(DevProx.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
Devmfm:sadd(DevProx.."List:Cmd:Group:New"..msg.chat_id_,"تك")
Devmfm:set(DevProx.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
Devmfm:sadd(DevProx.."List:Cmd:Group:New"..msg.chat_id_,"م")
Devmfm:set(DevProx.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
Devmfm:sadd(DevProx.."List:Cmd:Group:New"..msg.chat_id_,"اد")
Devmfm:set(DevProx.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
Devmfm:sadd(DevProx.."List:Cmd:Group:New"..msg.chat_id_,"مد")
Devmfm:set(DevProx.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
Devmfm:sadd(DevProx.."List:Cmd:Group:New"..msg.chat_id_,"من")
Devmfm:set(DevProx.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
Devmfm:sadd(DevProx.."List:Cmd:Group:New"..msg.chat_id_,"اس")
Devmfm:set(DevProx.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
Devmfm:sadd(DevProx.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
Devmfm:set(DevProx.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
Devmfm:sadd(DevProx.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
...
Welcomes = '*وففـہ حـاتہ تعـبوسككہ 🍇🕷️ *\n• [firstname lastname] \n• [@username]'
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ *لاتسۧتطيٰع حظر المطور الثانوي*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
...
if Devmfm:sismember(mustafa..'mfm:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ *لاتسۧتطيٰع كتم المطور الثانوي*", 1, 'md')
return false 
end
...
--     Source Escobar     --
if text == 'طرد المحذوفين' or text == 'مسح المحذوفين' or text == 'طرد الحسابات المحذوفه' or text == 'حذف المحذوفـيٰن' then  
...
local mfmname = '✘ ∫ آلَعضــوُ ⏎ ['..dp.first_name_..'](tg://user?id='..dp.id_..')'
